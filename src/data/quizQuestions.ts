...
export const allQuestions: QuizQuestion[] = [
  ...
  { id: 'm20', question: 'What plant grew to shade Jonah?', options: ['Fig tree', 'Vine', 'Gourd', 'Palm tree'], correctIndex: 2, category: 'minorProphets', difficulty: 'medium', reference: 'Jonah 4:6' },
  ...
  { id: 'o12', question: 'What was the source of Samson\'s strength?', options: ['His muscles', 'His faith', 'His hair', 'God\'s spirit'], correctIndex: 2, category: 'oldTestament', difficulty: 'easy', reference: 'Judges 16:17' },
