...
const translations: Translations = {
  ...
  // Level System
  level: { en: 'Level', it: 'Livello', es: 'Nivel', pt: 'Nível', fr: 'Niveau' },
  totalPoints: { en: 'Total Points', it: 'Punti Totali', es: 'Puntos Totales', pt: 'Pontos Totais', fr: 'Points Totaux' },
  nextLevel: { en: 'Next', it: 'Prossimo', es: 'Siguiente', pt: 'Próximo', fr: 'Suivant' },
  maxLevelReached: { en: 'Maximum level reached!', it: 'Livello massimo raggiunto!', es: '¡Nivel máximo alcanzado!', pt: 'Nível máximo alcançado!', fr: 'Niveau maximum atteint!' },
  allLevels: { en: 'All Levels', it: 'Tutti i Livelli', es: 'Todos los Niveles', pt: 'Todos os Níveis', fr: 'Tous les Niveaux' },
  levelBeginner: { en: 'Beginner', it: 'Principiante', es: 'Principiante', pt: 'Iniciante', fr: 'Débutant' },
  levelApprentice: { en: 'Apprentice', it: 'Apprendista', es: 'Aprendiz', pt: 'Aprendiz', fr: 'Apprenti' },
  levelStudent: { en: 'Student', it: 'Studente', es: 'Estudiante', pt: 'Estudante', fr: 'Étudiant' },
  levelScholar: { en: 'Scholar', it: 'Studioso', es: 'Erudito', pt: 'Estudioso', fr: 'Érudit' },
  levelExpert: { en: 'Expert', it: 'Esperto', es: 'Experto', pt: 'Especialista', fr: 'Expert' },
  levelMaster: { en: 'Master', it: 'Maestro', es: 'Maestro', pt: 'Mestre', fr: 'Maître' },
  levelSage: { en: 'Sage', it: 'Saggio', es: 'Sabio', pt: 'Sábio', fr: 'Sage' },
  levelProphet: { en: 'Prophet', it: 'Profeta', es: 'Profeta', pt: 'Profeta', fr: 'Prophète' },
  levelApostle: { en: 'Apostle', it: 'Apostolo', es: 'Apóstol', pt: 'Apóstolo', fr: 'Apôtre' },
  levelSaint: { en: 'Saint', it: 'Santo', es: 'Santo', pt: 'Santo', fr: 'Saint' },
  yourLevel: { en: 'Your Level', it: 'Il Tuo Livello', es: 'Tu Nivel', pt: 'Seu Nível', fr: 'Votre Niveau' },
